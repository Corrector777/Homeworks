...
match ingredients:
    ...
    case [*rest] if 'яд' in rest and 'трава' in rest:  # Добавьте новый рецепт зелья, требующий точно два определённых ингредиента. Опять же открыт вопрос с последовательностью элементов в списке(строка 138)
